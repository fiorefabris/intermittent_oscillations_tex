...
%%% bibliografía
\usepackage[backend=biber, url=false, doi=false, isbn=false, style=alphabetic, maxalphanames=1]{biblatex}
...
\linespread{1} %espacio entre lineas
%\makenomenclature
\usepackage{subfiles}
\begin{document}
...
\chaptermark{Las oscilaciones dependen de ...}
\label{ch3}
...
\label{ch5}
\chaptermark{Modelo de fase con bifurcación de ciclo infinito con ruido blanco gaussiano}
